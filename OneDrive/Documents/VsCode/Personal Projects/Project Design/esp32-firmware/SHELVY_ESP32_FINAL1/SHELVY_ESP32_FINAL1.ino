// SHELVY_ESP32_v5_cloud.ino
// Bread storage chamber controller — v5.
//
...
// ============================================================
// 2. DFR0588 CONVERSION (fixed 0.3-2.7V window, calibrated to FY-12)
// ============================================================
...
// FINAL calibration vs FY-12 on CLEAN USB/Pi power:
//   temp  raw ~33C  -> real ~30.7C  => -2.5
//   humid raw ~86%  -> real ~93-94% => +8.0
const float TEMP_CAL_OFFSET = -2.5f;
const float HUMI_CAL_OFFSET = 8.0f;
